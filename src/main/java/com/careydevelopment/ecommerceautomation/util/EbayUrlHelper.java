...
public class EbayUrlHelper {
	...
	public static String getFindItemsUrl(String keywords,String categoryId, int pageNumber, String appId) {
		...
		url += "&RESPONSE-DATA-FORMAT=XML&REST-PAYLOAD&productId.@type=UPC&productId=024543611363&itemFilter%280%29.name=Condition&itemFilter%280%29.value=New&sortOrder=PricePlusShippingLowest&itemFilter%281%29.name=LocatedIn&itemFilter%281%29.value=US&itemFilter%282%29.name=Currency&itemFilter%282%29.value=USD&itemFilter%283%29.name=TopRatedSellerOnly&itemFilter%283%29.value=true";
		...
		LOGGER.info("ebay find url is " + url);
	...
	public static String getSpecificItemUrl(String itemId, String appId) {
		...
		url += appId;
		url+= "&siteid=0&version=661&IncludeSelector=Description,ItemSpecifics,Variations,ShippingCosts&ItemID=";
		url += itemId;
